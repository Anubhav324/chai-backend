...
const loginUser =asyncHandler(async (req,res) =>{
    ...
    //check username or email present
...
const refreshAccessToken=asyncHandler(async(req,res) =>{
    ...
    try {
        ...
        .status(200)
        .cookie("accessToken",accessToken,options)
        .cookie("refreshTken",newRefreshToken,options)
        .json(
            new ApiResponse(
                200,
...
const getUserChannelProfile=asyncHandler(async(req,res)=>{
    ...
    .status(200)
    .json(
        new ApiResponse(200,channel[0],"user chanel fetched successfully")//aggregate returns an array whose first element is object which stores all the information
    )
})
